...
const TermsConditionLayer = () => {
    ...
    const [value, setValue] = useState(`<div id="editor">
        <p class="">This policy explains how 6amMart website and related applications (the â€œSiteâ€, â€œweâ€ or â€œusâ€)
        ...
        <p><br /></p>
        <p> our services on the Site, and references to this â€œSiteâ€, â€œweâ€ or â€œusâ€ is intended . grocery items to be
